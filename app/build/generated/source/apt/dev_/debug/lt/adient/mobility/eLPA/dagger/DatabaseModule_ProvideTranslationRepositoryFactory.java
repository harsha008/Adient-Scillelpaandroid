...
public final class DatabaseModule_ProvideTranslationRepositoryFactory
    implements Factory<TranslationRepository> {
  private final DatabaseModule module;

  private final Provider<DatabaseHelper> databaseHelperProvider;

  public DatabaseModule_ProvideTranslationRepositoryFactory(
  ...
  public TranslationRepository get() {
    return Preconditions.checkNotNull(
        module.provideTranslationRepository(databaseHelperProvider.get()),
        "Cannot return null from a non-@Nullable @Provides method");
  }

  public static Factory<TranslationRepository> create(
      DatabaseModule module, Provider<DatabaseHelper> databaseHelperProvider) {
    return new DatabaseModule_ProvideTranslationRepositoryFactory(module, databaseHelperProvider);
  }
}
